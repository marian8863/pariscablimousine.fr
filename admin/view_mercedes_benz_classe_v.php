        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item ">MERCEDES-BENZ Classe V Detail
              <?php
              ...
              <div class="row">
                ...
                <table id="example2"  class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php  
                    $sql="select sp.p_id,sp.p_place,sp.d_place,rp.1_2P,rp.3P,rp.4P from select_places sp , rates_payment rp where sp.p_id=rp.p_id";         
                    $res=$con->query($sql);
                    ...
                    <!-- //<td>< $row['d_id']?></td> -->
                        ...
                        <td>
                            <a href="create_mercedes_benz_classe_v.php?get_id=<?= $row["p_id"]?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
